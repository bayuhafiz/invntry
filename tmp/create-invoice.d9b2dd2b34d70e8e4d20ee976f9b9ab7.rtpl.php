            ...
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" style="left: 100px;text-align: left;">
             ...
             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12" style="left: 100px;top:15px;text-align: right;">
                ...
                <h5 class="bold">Due date: 
                    <input type="text" name="invoice_date" value="<?php echo $dueDate;?>" class="datepicker" id="endDate" data-date-format="MM dd, yyyy" style="text-align:right; width:130px;">
                </h5>
                <input type="hidden" name="invoiceDuedate" value="<?php echo $dueDate;?>">
            </div>
        </div>
        <div class="row row-centered">
                    ...
                    <table class="table table-hover" id="invoice1">
                        ...
                        <tbody class="createIntovicetb">
                            ...
                            <?php if( $pickedItems != '' ){ ?>
                                ...
                                <?php $counter1=-1; if( isset($pickedItems) && is_array($pickedItems) && sizeof($pickedItems) ) foreach( $pickedItems as $key1 => $value1 ){ $counter1++; ?>

                                <tr>
                                    <td>
                                        <input type="text" name="itemName[]" id="tableItemName" class="itemName tableItemName" value="<?php echo $value1["itemName"];?>" placeholder="item" required> 
                
                                    </td>
                                    <td>
                                        <input type="text" name="itemDescription[]" id="tableItemDescription" class="tableItemDescription" value="<?php echo $value1["itemDescription"];?>" placeholder="description" required>
                                    </td>
                                    <td>
                                        <input type="text" name="itemPrice[]" id="tableItemPrice" class="itemPrice tableItemPrice" value="<?php echo $value1["itemPrice"];?>" >
                                    </td>
                                    <td>
                                        <input type="text" name="itemQuantity[]" id="tableItemQuantity" class="itemQuantity itemNumeric tableItemQuantity" value="<?php echo $value1["itemQuantity"];?>">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="itemID[]" class="hiddenItemID" value="<?php echo $value1["itemID"];?>">
                ...
                <h6>TAXES/FEES
                    <select class="taxes" name="taxes" id="taxes">
                        ...
                        <?php $counter1=-1; if( isset($invoiceTaxes) && is_array($invoiceTaxes) && sizeof($invoiceTaxes) ) foreach( $invoiceTaxes as $key1 => $value1 ){ $counter1++; ?>
                            ...
                            <option value="<?php echo $value1["taxRate"];?>"><?php echo $value1["taxRate"];?>%</option>
                        <?php } ?>
